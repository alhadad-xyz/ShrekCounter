...
<head>
  ...
  <!-- Google Font -->
  <link rel="stylesheet" href="AdminLTE-2/https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,600,700,300italic,400italic,600italic">
  @stack('css')
</head>
...
<div class="wrapper">
  ...
  <!-- /.content-wrapper -->
  @includeIf('layout.footer', ['some' => 'data'])
</div>
<!-- ./wrapper -->
