...
<div class="row">
    <div class="col-lg-12">
            <div class="box-body">
                ...
                <table class="table table-stiped table-bordered tabel-penjualan">
                    <thead>
                        <th width="5%">No</th>
                        <th>Kode</th>
                        <th>Nama</th>
...
<script>
    ...
    $(function () {
        ...
        .on('draw.dt', function () {
            loadForm($('#diskon').val());
            setTimeout(() => { //untuk mentrigger diterima
        ...
        $('.btn-simpan').on('click', function() {
            $('.form-penjualan').submit(); //untuk mensubmit
        });
        // $(document).on('input', '.quantity', function () {
        //     let id = $(this).data('id');
        //     let jumlah = parseInt($(this).val());
    ...
    //         $('#kembali').val('Rp.'+ response.kembalirp);
    //         if ($('#diterima').val() != 0) {
    //             $('.tampil-bayar').text('Kembali: Rp. '+ response.bayarrp);
    //             $('.tampil-terbilang').text(response.kembali_terbilang);
    //         }
    //     })
    //     .fail(errors => {
    //         alert('gak bisa nampilin data masseh')
    //         return;
    //     })
    // }
    // unction loadForm(diskon = 0) {
    //     $('#total').val($('.total').text());
    //     $('#total_item').val($('.total_item').text());
